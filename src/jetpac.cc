...
int esat::main(int argc, char** argv) {
  ...
  /*                                                                                */
  esat::SpriteHandle live_icon_ = esat::SpriteFromFile("../assets/sprites/general/live_icon.png");
  /****  INIT VARIABLES *****/
  ...
  /*                                                                              	*/
  esat::DrawSetTextFont("../assets/fonts/zx-spectrum.ttf");
  LoadHighScore();
...
void readLevelFromFile(){
  ...
  file = fopen("../assets/levels.dat","rb");
  if(!file){
...
void saveProgress(Player player){
  ...
  datFile = fopen("../assets/save.dat", "wb");
  if (datFile == NULL) {
...
void InitTerrain(){
  if(terrain != NULL){
    ...
    // FLOOR
    (terrain + 0)->sprite = esat::SpriteFromFile("../assets/sprites/terrain/floor.png");
    ...
    (terrain + 1)->sprite = esat::SpriteFromFile("../assets/sprites/terrain/grass2.png");
    ...
    (terrain+1)->height = 32;
    /*                                      */
    (terrain + 2)->sprite = esat::SpriteFromFile("../assets/sprites/terrain/grass2.png");
    ...
    (terrain + 3)->sprite = esat::SpriteFromFile("../assets/sprites/terrain/grass1.png");
...
void InitPlayer(Player* player){
  ...
  if(player->sprite!=NULL){
    *(player->sprite+0) = esat::SpriteFromFile("../assets/sprites/player/player1.png");
    *(player->sprite+1) = esat::SpriteFromFile("../assets/sprites/player/player4.png");
    *(player->sprite+2) = esat::SpriteFromFile("../assets/sprites/player/player3.png");
    *(player->sprite+3) = esat::SpriteFromFile("../assets/sprites/player/player2.png");
    *(player->sprite+4) = esat::SpriteFromFile("../assets/sprites/player/flyplayer1.png");
    *(player->sprite+5) = esat::SpriteFromFile("../assets/sprites/player/flyplayer2.png");
    *(player->sprite+6) = esat::SpriteFromFile("../assets/sprites/player/flyplayer3.png");
    *(player->sprite+7) = esat::SpriteFromFile("../assets/sprites/player/flyplayer4.png");
...
void SaveHighScore() {
  FILE *file = fopen("../assets/highscore.txt", "w"); // Open a write file
...
void LoadHighScore() {
  FILE *file = fopen("../assets/highscore.txt", "r"); // opens the file in only reading mode, with no writing
  // check if the file opened great
  if (file != NULL) {
...
void InitObject(Object** object){
  const char *path[KnumberOfPickups] = {
    "../assets/sprites/objects/fuel.png",
    "../assets/sprites/objects/atom.png",
    "../assets/sprites/objects/diamond.png",
    "../assets/sprites/objects/lingot.png",
    "../assets/sprites/objects/nuke.png",
    "../assets/sprites/objects/slime.png",
  };
    ...
    if(ship->component!=NULL){
      ...
      switch(gm.level.current_level){
        case 1:
          ...
          (ship->component)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/a_rocket1.png");
          (ship->component+1)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/a_rocket2.png");
          (ship->component+2)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/a_rocket3.png");
        break;
        case 2:
          //Rocket 2 sprite component loading from file b_rocket[1-3].png
          (ship->component)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/b_rocket1.png");
          (ship->component+1)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/b_rocket2.png");
          (ship->component+2)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/b_rocket3.png");
        break;
        case 3:
          //Rocket 3 sprite component loading from file c_rocket[1-3].png
          (ship->component)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/c_rocket1.png");
          (ship->component+1)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/c_rocket2.png");
          (ship->component+2)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/c_rocket3.png");
        break;
        case 4:
          //Rocket 3 sprite component loading from file d_rocket[1-3].png
          (ship->component)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/d_rocket1.png");
          (ship->component+1)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/d_rocket2.png");
          (ship->component+2)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/d_rocket3.png");
        break;
      }
      //Rocket fire sprites (2). 
      (ship->component+3)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/fire1.png");
      (ship->component+4)->sprite = esat::SpriteFromFile("../assets/Sprites/rocket/fire2.png");
...
RayComponent* AddSubRays(Player player) {
  ...
  if( (sub_rays) != NULL ){
    for (int i = 0; i < KNumbersOfSubRays ; i++) {
        (sub_rays+i)->sprite = esat::SpriteFromFile("../assets/sprites/objects/thinRay.png");
  ...
  *enemies = (Enemy*)malloc(kNenemys * sizeof(Enemy));
  ...
  if(*enemies != NULL){
    for(int i=0; i < kNenemys; i++){
      ...
      *((*enemies + i)->sprite + 2) = esat::SpriteFromFile("../assets/sprites/general/cloud1.png");
      *((*enemies + i)->sprite + 3) = esat::SpriteFromFile("../assets/sprites/general/cloud2.png");
      *((*enemies + i)->sprite + 4) = esat::SpriteFromFile("../assets/sprites/general/cloud3.png");
    }
  }
}
void KillEnemies(Enemy* enemies, int kNenemys){
  ...
  //1 IS RED, 2 IS BLUE, 3 IS GREEN, 4 IS VIOLET AND 0 IS WHITE
    ...
    */
    ...
    case EnemyType::kType_Asteroid: {
      ...
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_asteroid1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_asteroid2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_asteroid1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_asteroid2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_asteroid1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_asteroid2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_asteroid1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_asteroid2.png");
          break;
        }
      }
      break;
    ...
    */
    ...
    case EnemyType::kType_Spikes :{
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_spikes1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_spikes2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_spikes1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_spikes2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_spikes1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_spikes2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_spikes1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_spikes2.png");
          break;
        }
      }
      break;
    ...
    */
    ...
    case EnemyType::kType_Bubble :{
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_bubble1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_bubble2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_bubble1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_bubble2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_bubble1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_bubble2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_bubble1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_bubble2.png");
          break;
        }
      }
      break;
    ...
    */
    ...
    case EnemyType::kType_Ship :{
      switch((enemies)->color){
        case 0:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/whi_ship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/whi_ship2.png");
          break;
        }
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_ship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_ship2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_ship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_ship2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_ship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_ship2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_ship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_ship2.png");
          break;
        }
      }
      break;
    ...
    */
    ...
    case EnemyType::kType_UFO :{
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_ufo1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_ufo2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_ufo1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_ufo2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_ufo1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_ufo2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_ufo1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_ufo2.png");
          break;
        }
      }
      break;
    ...
    */
    ...
    case EnemyType::kType_Frog :{
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_frog1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_frog2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_frog1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_frog2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_frog1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_frog2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_frog1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_frog2.png");
          break;
        }
      }
      (enemies)->direction = 1;
    ...
    */
    ...
    case EnemyType::kType_Cross :{
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_cross1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_cross2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_cross1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_cross2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_cross1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_cross2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_cross1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_cross2.png");
          break;
        }
      }
      break;
    ...
    */
    ...
    case EnemyType::kType_Starship :{
      switch((enemies)->color){
        case 1:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/red_starship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/red_starship2.png");
          break;
        }
        case 2:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/blu_starship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/blu_starship2.png");
          break;
        }
        case 3:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/grn_starship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/grn_starship2.png");
          break;
        }
        case 4:{
          *((enemies)->sprite) = esat::SpriteFromFile("../assets/sprites/enemy/vio_starship1.png");
          *((enemies)->sprite + 1) = esat::SpriteFromFile("../assets/sprites/enemy/vio_starship2.png");
          break;
        }
      }
      break;
